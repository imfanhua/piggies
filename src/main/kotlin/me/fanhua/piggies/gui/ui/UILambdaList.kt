...
class UILambdaList<T>(
	...
	var handler: ((UILambdaList<T>, Player, ClickType, Int, Int, T, Int) -> Unit)? = null,
	...
	fun onUse(handler: (ui: UILambdaList<T>, clicker: Player, type: ClickType, x: Int, y: Int, value: T, index: Int) -> Unit) = apply {
